...
const toggleLanguage = async () => {
    ...
    await router.push({
        ...route,
        query: { ...route.query, lang: locale.value },
    });
};
    ...
    <div id="app" v-cloak>
        ...
        <div class="scene-container">
            ...
            <div class="envelope-wrapper" :style="envelopeWrapperStyle">
                ...
                ></div>
                <div class="wax-seal" :style="sealStyle"><span>❁</span></div>
                ...
                <div class="scroll-clipper" :style="clipperStyle">
                    ...
                    >
                        ...
                        <div class="scroll-section pt-12">
                            ...
                            >
                                <div class="font-display countdown-item">
                        ...
                        <div class="scroll-section">
                            ...
                            <div class="grid md:grid-cols-2 gap-12">
                                <div>
                                    ...
                                    <p
                                        class="font-display text-xs tracking-widest text-accent mb-4"
                                    >
                                        {{ $t("couple.bride") }}
                                    </p>
                                    <p
                                        class="font-display text-sm italic opacity-80"
                                    >
                        ...
                        <div class="scroll-section">
                            ...
                            <p class="font-display text-lg opacity-80 mb-4">
                                {{ t("hero.venue_addr") }}
                            </p>
                            <a
                        ...
                        <div class="scroll-section">
                            ...
                            <div class="relative max-w-2xl mx-auto">
                                ...
                                >
                                    ...
                                    >
                                        <span
                                            class="font-display font-bold text-accent text-xl block mb-1"
                                            >{{
                                        ...
                                        <p
                                            class="font-display text-sm italic opacity-70"
                                        >
                        ...
                        <!-- 5. DRESS CODE -->
                        <div class="font-display scroll-section">
                                ...
                                >
                                    ...
                                    <ul class="text-sm space-y-2 italic">
                                        <li class="whitespace-pre-line">
                                            {{
                                                t("dresscode.female_dresscode")
                                            }}
                                        </li>
                                        <li
                                            class="font-display font-bold text-accent not-italic border border-accent px-2 py-1 inline-block"
                                        >
                        ...
                        <div class="scroll-section pb-8">
                            ...
                            <div v-else class="py-8">
                                ...
                                <p
                                    class="font-display mt-2 font-display text-sm"
                                >
                                    {{ t("rsvp.success_msg") }}
                                </p>
                            </div>
...
:root {
    ...
    --envelope-front: #fff3e6;
    --envelope-back: #ffd9b3;
    --envelope-inside: #fff3e6;
    --seal-color: var(--color-light-green); /* Use primary accent for seal */
}
...
/* --- TYPOGRAPHY --- */
.font-script {
    @apply font-[FzManstein];
}
.font-display {
    @apply font-[UVNNhan] uppercase;
}
